...
export default function SearchBooksPage() {
  ...
  useEffect(() => {
    const fetchBooks = async () => {
      ...
      if (!response.ok) throw new Error('Something went wrong fetching the searched for data');
    ...
    // scroll to top of page when useEffect is called
    window.scrollTo(0, 0);
        ...
        <div>
          ...
          {totalAmountOfBooks > 0 ?
            ...
            <div className="m-5">
              ...
              <a type="button" className="btn main-color btn-md px-4 me-md-2 fw-bold text-white" href="#">Library
                Services</a>
            </div>}
